function switchComment() {
  const t =
      "�л�ΪGitalk" === $("#switch-comment").attr("title")
        ? "�л�ΪValine"
        : "�л�ΪGitalk",
    o = $("#switch-comment>i");
...
if (commentElement != undefined) {
  commentElement.innerHTML +=
    '<a id="switch-comment" href="javascript:void(0);" title="�л�ΪGitalk" target="_self"><i class="fa fas fa-toggle-off" aria-hidden="true"></i></a>';
